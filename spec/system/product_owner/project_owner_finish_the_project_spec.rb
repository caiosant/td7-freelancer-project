...
describe 'project owner finish the project' do
  it 'and must be signed in' do
    ...
    expect(page).to_not have_content('Descrição: Este projeto da Handa promete garantir qualidade de vida para ' \
                                     'muitos connect on Linked in. A Oestia, grupo que promove a intervenção da ' \
                                     'Handa no público, promoveu há cerca de três anos.')
  ...
  it 'and got successfully' do
    ...
    expect(page).to have_content('Descrição: Este projeto da Handa promete garantir qualidade de vida para muitos ' \
                                 'connect on Linked in. A Oestia, grupo que promove a intervenção da Handa no ' \
                                 'público, promoveu há cerca de três anos.')
