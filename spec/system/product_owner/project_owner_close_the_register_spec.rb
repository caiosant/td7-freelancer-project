...
describe 'project owner close the application,' do
  it 'got successfuly and freelancer can see the project' do
    ...
    projeto_caio = Project.create!({ title: 'Projeto de Sistema',
                                     ...
                                     project_owner: caio })
    projeto_caio2 = Project.create!({ title: 'Projeto Sistema 2.0',
                                      description: 'Projeto do caio 2.0 adsadadadasdadadasdadadsaddadasdadadsada',
                                      max_value: 120,
    ...
    profile_freelancer = freelancer.profile.update!({ full_name: 'teste primeiro tester',
                                                      social_name: 'teste primeiro tester',
    ...
    expect(page).to_not have_content("Forma de trabalho: #{Project.human_enum_name(:locations,
                                                                                   projeto_caio2.location)}")
  end
