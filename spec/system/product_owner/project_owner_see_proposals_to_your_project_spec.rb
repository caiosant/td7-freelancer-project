...
describe 'p.o see proposals' do
  it 'and got successfully' do
    ...
    profile_freelancer = freelancer.profile.update!({ full_name: 'teste primeiro tester',
                                                      social_name: 'teste primeiro tester', birth_date: '1995-04-03', occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas' })

    freelancer1 = Freelancer.create!({ email: 'teste@tester1.com', password: '1234567' })
    profile_freelancer1 = freelancer1.profile.update!({ full_name: 'teste tester1', social_name: 'teste tester1',
                                                        birth_date: '1995-04-04', occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas1' })

    proposal1 = Proposal.create!({
                                   application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto caio', hour_value: 30, hours: 30, deadline_proposal: 10.days.from_now, freelancer: freelancer, project: projeto_caio
                                 })
    proposal2 = Proposal.create!({
                                   application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto anderson', hour_value: 30, hours: 30, deadline_proposal: 10.days.from_now, freelancer: freelancer, project: projeto_anderson
                                 })
    proposal3 = Proposal.create!({
                                   application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto caio - by 1', hour_value: 30, hours: 30, deadline_proposal: 10.days.from_now, freelancer: freelancer1, project: projeto_caio
                                 })
    proposal4 = Proposal.create!({
                                   application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto anderson - by 1', hour_value: 30, hours: 30, deadline_proposal: 10.days.from_now, freelancer: freelancer1, project: projeto_anderson
                                 })
  ...
  it 'and go to the full proposal view' do
    ...
    freelancer1 = Freelancer.create!({ email: 'teste@tester1.com', password: '1234567' })
    profile_freelancer1 = freelancer1.profile.update!({ full_name: 'teste tester1', social_name: 'teste tester',
                                                        birth_date: '1995-04-04', occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas1' })
  ...
  it 'and has a accepted proposal' do
    ...
    occupation_area = OccupationArea.create!({ name: 'Desenvolvimento web' })
    freelancer = Freelancer.create!({ email: 'teste@tester.com', password: '1234567' })
    profile_freelancer = freelancer.profile.update!({ full_name: 'teste tester', social_name: 'teste tester',
                                                      birth_date: '1995-04-03', occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas' })
    ...
    proposal1 = Proposal.create!({
                                   application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto caio', hour_value: 30, hours: 30, deadline_proposal: 9.days.from_now, freelancer: freelancer, project: projeto_caio
                                 })
    proposal2 = Proposal.create!({
                                   application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto caio - by 1', hour_value: 40, hours: 40, deadline_proposal: 10.days.from_now, freelancer: freelancer1, project: projeto_caio
                                 })
  ...
  it 'and has a accepted proposal' do
    ...
    proposal1 = Proposal.create!({ application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto ' \
                                                       'caio',
                                   hour_value: 30,
                                   hours: 30,
                                   deadline_proposal: 9.days.from_now,
                                   freelancer: freelancer,
                                   project: projeto_caio })

    proposal2 = Proposal.create!({ application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar projeto ' \
                                                       'caio - by 1',
                                   hour_value: 40,
                                   hours: 40,
    ...
    expect(page).to have_content('Projeto: Projeto de Sistema')
    expect(page).to have_content('Descrição: Este projeto da Handa promete garantir qualidade de vida para ' \
