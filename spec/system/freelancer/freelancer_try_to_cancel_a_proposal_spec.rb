...
describe 'Freelancer try to cancel a proposal' do
  it 'and cancel his proposal when the proposal status is pending' do
    ...
    profile_freelancer = freelancer.profile.update!({ full_name: 'teste tester', social_name: '',
    ...
    proposal = Proposal.create!({ application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar nele',
                                  hour_value: 30, hours: 30, freelancer: freelancer, project: projeto_po })
  ...
  it 'and cancel his proposal when the proposal status is accept more them 3 days' do
    travel_to 10.days.ago do
      ...
      occupation_area = OccupationArea.create!({ name: 'Desenvolvimento web' })
      freelancer = Freelancer.create!({ email: 'teste@tester.com', password: '1234567' })
      freelancer.profile.update!({ full_name: 'teste tester', social_name: '', birth_date: '1995-04-03',
                                   occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas' })

      Proposal.create!({ application_reason: 'Projeto dos meus sonhos, gostaria muito de trabalhar nele',
                         hour_value: 30, hours: 30, freelancer: freelancer, project: projeto_po })
    end
