...
describe 'Freelancer goes to a project with a proposal accepted proposal' do
  it 'and must be signed in' do
    ...
    profile_freelancer = freelancer.profile.update!({ full_name: 'teste primeiro tester',
                                                      social_name: 'teste primeiro tester_social', birth_date: '1995-04-03', occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas' })
  ...
  it 'and see the team' do
    ...
    profile_freelancer1 = freelancer1.profile.update!({ full_name: 'teste tester1',
                                                        social_name: 'teste tester1_social', birth_date: '1995-04-04', occupation_area: occupation_area, description: 'Grande profissional da área de T.I. com mais de 10 anos de exp atuando em grandes empresas1' })
